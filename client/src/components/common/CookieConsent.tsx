  ...
  return (
    <Slide direction="up" in={showConsent} mountOnEnter unmountOnExit>
      ...
      >
        ...
        >
          Seuraamme vain: sivuvierailut, kartan käyttö (2D/3D) ja ominaisuuksien
          suosio. Kaikki tiedot ovat nimettömiä ja GDPR-yhteensopivia.
        </Typography>
        ...
        >
          Voit muuttaa valintaasi milloin tahansa sivuston asetuksista.
        </Typography>
      </Paper>
    </Slide>
  );
